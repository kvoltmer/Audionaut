...
ChannelComponent::ChannelComponent (std::shared_ptr<AudioResource> resource, std::shared_ptr<AudiumEngine> engine)
{
    ...
    volumeLevel->setColour (juce::Label::textColourId, juce::Colours::white);
    volumeLevel->setColour (juce::TextEditor::textColourId, juce::Colours::black);
...
void ChannelComponent::resized()
{
    ...
    volumeLeveldB->setBounds (20, 50 - (20 / 2), 30, 20);
    juce__imageButton2->setBounds (60 - 10, 0, 10, 100);
    volumeLevel->setBounds (0, 50 - (20 / 2), 27, 20);
