...
#if ESSENTIA_ENABLED
SCENARIO("BeatDegaraSegmenter tracks beats in an audio file", "[engine][analysis][beats]")
{
...
SCENARIO("BeatDegaraSegmenter returns no beats for a missing file", "[engine][analysis][beats]")
{
    BeatDegaraSegmenter segmenter;
